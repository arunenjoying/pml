...
As we can see that **modelFit1** has best accuracy of **`r modelFit1Accuracy` %**. Although there is not huge difference between the accuracy of different models, we would still go forward with the best among the 3 models and store it in the variable modelFitFinal.
